    ...
    <div>
      <!-- <div v-loading="loading" class="brief-box">
        <div class="brief-title">
          ...
          <span class="text">监控简报</span>
        </div>
        <div class="brief">
          <flexbox v-for="(item, index) in briefList" :key="index" :span="2" class="brief-item"
        ...
        <el-col :xs="24" :sm="24" :lg="12">
          <div class="chart-wrapper" style="position: relative">
            <el-tabs v-model="activeName" @tab-click="handleClick">
              <el-tab-pane label="网管告警" name="collectedAmount" />
              <el-tab-pane label="服务监控" name="signAmount" />
              <el-tab-pane label="服务告警" name="clientNum" />
              <el-tab-pane label="容器监控" name="invoiceAmount" />
              <el-tab-pane label="网关设备" name="outAmount" />
            </el-tabs>
            <!-- <div class="chartBox">
              <p>
                <span>完成值：</span>
