        ...
        <div class="filter-container">
            ...
            <el-form :inline="true" :model="listQuery" class="demo-form-inline">
                <el-form-item label="策略名称">
                    <el-input v-model="listQuery.filter" placeholder="请输入策略名称"></el-input>
                </el-form-item>
                <el-form-item label="数据输入类型">
                    <el-input v-model="listQuery.filter" placeholder="请输入数据输入类型"></el-input>
                </el-form-item>
                <el-form-item label="数据输入地址">
                    <el-input v-model="listQuery.filter" placeholder="请输入数据输入地址"></el-input>
                </el-form-item>
                <el-form-item>
