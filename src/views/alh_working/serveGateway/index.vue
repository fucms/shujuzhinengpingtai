    ...
    <div class="app-container">
        <div class="filter-container">
            ...
            <el-table :key="tableKey" v-loading="listLoading" :data="list" border fit highlight-current-row
                ...
                <el-table-column label="简介" prop="type3" align="center">
                    <template slot-scope="{ row }">
                        <span>{{ row.code }}</span>
                    </template>
                </el-table-column>
                <el-table-column label="服务状态" prop="type3" align="center">
                    <template slot-scope="{ row }">
                        <el-tag :type="row.type == 1 ? 'primary' : 'success'">{{ row.type == 1 ? '进行中' : '已完成' }}</el-tag>
                    </template>
                </el-table-column>
