  ...
  <div>
    <el-dialog :title="title" :visible.sync="visible" style="padding-bottom: 5vh" width="50%">
      <el-form ref="dataForm" :model="temp" label-position="left" label-width="auto" :rules="rules">
        <el-row>
          <el-col :span="12">
            <el-form-item label="规则名称" prop="customerCode">
              <el-input v-model="temp.customerName1" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="应用设备" prop="customerName">
              <el-input v-model="temp.customerName2" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="响应设备" prop="customerName">
              <el-input v-model="temp.customerName3" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="执行命令" prop="customerName">
              <el-input v-model="temp.customerName4" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="检测规则条件" prop="customerName">
              <el-input v-model="temp.customerName5" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="响应发射数据" prop="customerName">
