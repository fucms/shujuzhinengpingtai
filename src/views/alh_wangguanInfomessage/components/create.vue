    ...
    <el-dialog :title="title" :visible.sync="visible" style="padding-bottom: 5vh" width="30%">
      <el-form ref="dataForm" :model="temp" label-position="left" label-width="auto" :rules="rules">
        <el-row>
          ...
          <el-col :span="24">
            <el-form-item label="设备位置" prop="customerName">
              <el-input v-model="temp.customerName2" />
            </el-form-item>
          </el-col>
          <el-col :span="24">
            <el-form-item label="IP地址" prop="customerName">
              <el-input v-model="temp.customerName3" />
            </el-form-item>
          </el-col>
          <el-col :span="24">
            <el-form-item label="MAC地址" prop="customerName">
              <el-input v-model="temp.customerName4" />
            </el-form-item>
          </el-col>
          <el-col :span="24">
            <el-form-item label="地区" prop="customerName">
              <el-input v-model="temp.address" />
            </el-form-item>
          </el-col>
          <el-col :span="24">
            <el-form-item label="序列号" prop="customerName">
